...
training_args = TrainingArguments(f"{model_name}-finetuned-characters-backstories",
                                report_to = "wandb", num_train_epochs = 1, ogging_steps = 1,
                                evaluation_strategy = "epoch", learning_rate = 1e-4,
...
prompts = ["Frogger Character Race: Aarakocra Character Class: Ranger Output: ",
