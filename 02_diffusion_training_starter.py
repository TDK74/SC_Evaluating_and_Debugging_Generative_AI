...
config = SimpleNamespace(num_samples = 30,
...
## ------------------------------------------------------ ##
perturb_input, sample_ddpm_context = setup_ddpm(config.beta1, config.beta2, config.timesteps,
                                                DEVICE)

## ------------------------------------------------------ ##
nn_model = ContextUnet(in_channels = 3, n_feat = config.n_feat, n_cfeat = config.n_cfeat,
